      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav nav-flex-icons">
                <li style="margin-top: 10px;">Data Archiving,</font> <?php echo ucwords(htmlentities($id)); ?></li>
            <li class="nav-item">
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="add_document.php" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-file-medical"></i> Add Title Docs</a>
        <a href="view_userfile.php" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-folder-open"></i> Deleted History</a>
...
<hr>
 ...
 <table id="dtable" class = "table table-striped">
    ...
    <th>Downloads</th>
    <th>Download|Restore|Permanent Deletion</th>
...
<tbody>
    ...
    <tr>
        ...
        require_once("include/connection.php");
        require_once("froicodes.php");
        $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE archive = 1 GROUP BY NAME DESC") or die (mysqli_error($conn));
      ...
      ?>
     <td width="50" height="15">SVCC<?php echo $id?></td>
      ...
      <td><?php echo $download; ?></td>
           ...
           <td><a href='downloads.php?file_id=<?php echo $id; ?>'  class="btn btn-sm btn-outline-primary"><i class="fa fa-download">
           </i></a> <a href='archive.php?ID=<?php echo $id; ?>'  class="btn btn-sm btn-outline-success"><i class="far fa-window-restore"></i></a>
         </i></a> <a href='deletepermanent.php?ID=<?php echo $id; ?>'  class="btn btn-sm btn-outline-danger"><i class="far fa-window-close"></i></a>
    </tr>
...
<?php } ?>
    ...
    <div class="footer-copyright py-3">
     <p>All right Reserved &copy; <?php echo date('Y');?> Created By: Student of SVCC</p>
    </div>
    <!--/.Copyright-->
