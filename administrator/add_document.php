...
<!--
    ...
    <a href="add_file.php"><button type="button" class="btn btn-success"><i class="fas fa-file-medical"></i>  Add Title File</button></a>
    </div>
...
<tbody>
    ...
    <tr>
        ...
        $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE archive = 0 GROUP BY NAME DESC") or die (mysqli_error($conn));
      ...
      ?>
     <td width="50" height="15">SVCC<?php echo $id?>CC</td>
      ...
      <td ><?php echo $download; ?></td>
           ...
           <td><a href='downloads.php?file_id=<?php echo $id; ?>'  class="btn btn-sm btn-outline-primary"><i class="fa fa-download"></i></a> <a href='delarchive.php?ID=<?php echo $id; ?>'  class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></a>
    </tr>
<?php } ?>
</tbody>
   </table>
