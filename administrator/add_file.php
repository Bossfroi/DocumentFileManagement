...
<h5 class="card-header info-color white-text text-center py-4">
  <strong>Upload File Title+</strong>
  </h5>
      ...
      <div class="row"><br><br>
        <form action="fileprocess.php" method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
           ...
           <label for="subject" class="">Upload Title</label>
          <input type="file" name="myfile"> <br>
          <button  type="submit" class="btn btn-info btn-rounded btn-block my-4 waves-effect z-depth-0"  name="save" type="submit">Upload Title</button>
         <footer style="font-size: 12px"><b>File Type:</b><font color="red"><i>.docx .doc .pptx .ppt .xlsx .xls .pdf .odt </i></font></footer>
        <footer style="font-size: 12px"><b>WARNING:</b><font color="red"><i>. File shouldn't be larger than 100Megabyte</i></font></footer>
